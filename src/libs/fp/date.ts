...
export const dateFormat = (format:string, date:Date):string => (dateFormat[format] = dateFormat[format] || createDateFormat(format))(date)
...
export const isSameDate = (d1:Date, d2:Date) => d1 && d2 && dateFormat("yyyy-mm-dd", d1) === dateFormat("yyyy-mm-dd", d2)